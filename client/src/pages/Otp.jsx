...
export default function Otp() {
  const[loading,setLoading]=useState(false)
    ...
    const handelResendOtp = async (e) => {
        ...
        const response = await axios.post('https://www.services.mygoldmalls.com/accounts/resend-otp/', {
    ...
    const handelSubmit = async (e) => {
      setLoading(true);
        ...
        const response = await axios.post('https://www.services.mygoldmalls.com/accounts/activate/', {
          phone_number: decoded.phone_number,
          otp: otp
        }, { headers: { 'Content-Type': 'application/json' } });
