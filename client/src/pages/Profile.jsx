...
export default function Profile() {
  ...
  const userDeatil = async () => {
    ...
    const response = await axios.post(
      "https://mygoldmalls:8000/accounts/userDetail/",
  ...
  useEffect(() => {
    const bankCard = async () => {
      const response = await axios.post(
        "https://mygoldmalls:8000/accounts/showmybankcard/",
  ...
  const handelWithdrawRequest = async (e) => {
    ...
    const response = await axios.post(
      "https://mygoldmalls:8000/accounts/withdraw/",
      {
        phone_number: decoded.phone_number,
        amount: withdraw,
  ...
  const handelRecharge = async (e) => {
    ...
    try {
      ...
      const decoded = jwt_decode(token);
      const response = await axios.post(
        "https://mygoldmalls:3001/recieve",
        {
  ...
  const getPaymentAck = async () => {
    try{
        ...
        const decoded = jwt_decode(token);
        const response = await axios.post(
          "https://mygoldmalls:3001/paymentAck",
          {
  ...
  useEffect(() => {
    ...
    const backendResponse = await axios.post(
      "https://mygoldmalls:8000/accounts/recharge/",
  ...
  const handelDeleteAccount = async (e) => {
    ...
    try {
      ...
      const decoded = await jwt_decode(token);
      const response = await axios.post(
        "https://mygoldmalls:8000/accounts/deleteMyAccount/",
        {
          phone_number: decoded.phone_number,
