...
export default function AdminPortal() {
  ...
  const handleRewardSubmit = async (e) => {
    ...
    const response = await axios.post(
      "https://stinghike.com/api/administ/reward/",
      {
  ...
  const handleAgentSubmit = async (e) => {
    ...
    const response = await axios.post(
      "https://stinghike.com/api/administ/add_agent/",
      {
  ...
  const handelDistributeIncome = async (e) => {
    e.preventDefault();
    const response = await axios.post(
      "https://stinghike.com/api/administ/distribute_income/",
      {},
      { headers: { "Content-Type": "application/json" } }
    );
    alert(response.data.message);
  ...
  const viewrecharge = (user) => {
    ...
    const dataFetch = async (e) => {
      ...
      const response = await axios.post(
        "https://stinghike.com/api/administ/",
      ...
      const overalldata = await axios.post(
        "https://stinghike.com/api/administ/all_detail/",
        {},
        { content: "application/json" }
      );
