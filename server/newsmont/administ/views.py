        ...
        if recharge_record:
            ...
            if recharge_record.user.recharge_amount == 0:
                ...
                if recommend_user:
                    ...
                    recommend_user.save()
                    income_object = Income.objects.create(user=recommend_user.user, amount=float(recharge_record.amount) * 0.25, income_type="Referral Rehcharge Income", income_date=timezone.now())
                    income_object.save()
